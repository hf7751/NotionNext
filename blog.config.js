...
const BLOG = {
  AUTHOR: '尚硅谷大数据', // 作者
  BIO: '大数据知识分享', // 作者简介
  LINK: 'https://sgger.cn', // 网站地址
  KEYWORDS: '大数据, 尚硅谷, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'b593f7e229294212b8baf2e18ff91182', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
